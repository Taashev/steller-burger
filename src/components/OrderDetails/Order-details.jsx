		...
		<ModalOverlay>
			<Modal>
				<div className={`pt-4 pb-15 ${styles['order-details']}`}>
					<div className={`text_type_digits-large mb-8`}>034536</div>
					<span className={`text_type_main-medium mb-15`}>идентификатор заказа</span>
					<svg className={`${styles['order-details__img']}`} viewBox="0 0 107 102" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
